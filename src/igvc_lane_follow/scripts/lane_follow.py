...
from igvc_lane_follow.cfg import LaneFollowDynCfgConfig
...
class LaneFollowNode():
    def __init__(self):
        ...
        self.srv = Server(LaneFollowDynCfgConfig,
...
if __name__ == '__main__':
    ...
    rospy.init_node('lane_folllow_node')
    print("Lane Follow node initialized")
